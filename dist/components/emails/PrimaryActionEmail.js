...
var EmailTemplate = function (_a) {
  var actionLabel = _a.actionLabel,
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      null,
      "The marketplace for high-quality TUB products."
    ),
    React.createElement(
      components_1.Body,
      { style: main },
...
var PrimaryActionEmailHtml = function (props) {
  return (0, components_1.render)(
    React.createElement(exports.EmailTemplate, __assign({}, props)),
    { pretty: true }
  );
};
