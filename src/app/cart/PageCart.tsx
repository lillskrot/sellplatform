...
export const PageCart = ({ user }: { user: User | null }) => {
  ...
  return (
    <div className="flex-grow mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
                  ...
                  <li key={product.id} className="flex py-6 sm:py-10">
                    ...
                    <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                      ...
                      <p className="mt-4 flex space-x-2 text-sm text-gray-700">
                        ...
                        <span>{/*Eligible for instant shipping*/}</span>
                      </p>
                    </div>
                  </li>
                );
        ...
        <section className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
          ...
          <div className="mt-6">
            <Button
              ...
              onClick={() => {
                router.push("/sign-up"); // Redirects to the signup page in Next.js
                // or
